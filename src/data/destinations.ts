...
export const destinations: Destination[] = [
  ...
  },
  {
    id: 'slovenie',
    name: 'Slovénie',
    country: 'Alpes · Adriatique',
    tagline: 'Les Alpes en miniature : lacs émeraude, gorges turquoise et une capitale de poche, à une porte de l’Italie.',
    intro:
      "Un pays grand comme une région qui condense Alpes enneigées, lacs glaciaires, rivières turquoise et un bout de côte adriatique. Tout est proche, vert et étonnamment préservé : Ljubljana, le lac de Bled et la vallée de la Soča en quelques jours.",
    flight: '≈ 2 h 00',
    budget: 2,
    budgetLabel: 'Modéré',
    season: 'Mai → septembre',
    seasonNote: 'Juin & septembre idéals ; été vert, hiver alpin',
    duration: '5–7 jours',
    tags: ['Alpes', 'Lacs', 'Rivières turquoise', 'Nature', 'Proche'],
    highlights: [
      { title: 'Lac de Bled', desc: 'L’île-église, le château perché et les barques pletna — la carte postale du pays.' },
      { title: 'Lac de Bohinj', desc: 'Plus grand et plus sauvage, au pied du massif du Triglav.' },
      { title: 'Gorges de Vintgar', desc: 'Passerelle de bois suspendue au-dessus d’une eau émeraude.' },
      { title: 'Vallée de la Soča', desc: 'La rivière turquoise : rafting, ponts suspendus et mémoire de la Grande Guerre.' },
      { title: 'Ljubljana', desc: 'Capitale piétonne, château et marchés au bord de la Ljubljanica.' },
      { title: 'Piran', desc: 'Joyau vénitien aux toits de terre cuite, sur la petite côte adriatique.' },
    ],
    pros: [
      'Alpes, lacs et mer réunis sur de courtes distances',
      'Nature exceptionnelle et très bien préservée',
      'Vol court, sûr, facile à parcourir en voiture',
      'Bon rapport qualité/prix, encore peu de foule',
    ],
    cons: 'Le Triglav et les lacs se méritent (météo de montagne) ; voiture recommandée.',
    scene: {
      kind: 'highlands',
      sky: ['#8aa6b0', '#dbe6dd'],
      land: '#2e5238',
    ...
    photo: '/photos/slovenie/slovenie-01.jpg',
    gallery: gallery('slovenie', 12),
  },
]
